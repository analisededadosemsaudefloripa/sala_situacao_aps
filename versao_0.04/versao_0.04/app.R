...
acesso_dat <- read_csv("base_de_dados/extraidas/dados_cs.csv", 
...
ui <- dashboardPage(skin = "blue",
                    ...
                    dashboardBody(
                      tabItems(
                        ########################################################################################### 
                        #Apresentação
                        tabItem(tabName = "apresentacao", h2("Acesso à Atenção Primária em Florianópolis"),
                                fluidRow(
                                  mainPanel(
                                ...
                                fluidRow(
                                  box(selectInput(
                                    ...
                                    choices=list("Médico" = "Médico", "Enfermeiro" = "Enfermeiro", "Odontólogo" = "Odontólogo",
                                                 "Médico e Enfermeiro" = "Médico e Enfermeiro", "Total" = "Total"),
                                    selected="Total"),
                        ...
                        #Primeira Consulta Odontológica
                        ###########################################################################################
                        tabItem(tabName = "prim_cons_odonto_florianopolis", h2("Acesso à Atenção Primária em Florianópolis"),
                        ...
                        tabItem(tabName = "cito_florianopolis", h2("Longitudinalidade na Atenção Primária em Florianópolis"),
                               ...
                               fluidRow(
                                   tabBox(title = "Percententual de Citopatológicos", width=12,
                        ...
                        tabItem(tabName = "encam_med_florianopolis", h2("Integralidade na Atenção Primária em Florianópolis"),
                                ...
                                fluidRow(
                                  box(selectInput(
                                    ...
                                    label="Selecione o Tipo:",
                                    choices=list("Consulta Médica" = "CONSULTA_MED", "Encaminhamento Médico" = "ENCS_MED", "Percentual de Encaminhamento Médico" = "PORCENT_ENCAMINHAMENTOS_MED",
                                                 "Consulta Odontológica" = "CONSULTA_ODO", "Encaminhamento Odontológico" = "ENCS_ODO", "Percentual de Encaminhamento Odontológico" = "PORCENT_ENCAMINHAMENTOS_ODO"),
                        ...
                        #Testes rápidos                                                         
                        ###########################################################################################
                        tabItem(tabName = "teste_rap_florianopolis", h2("Integralidade na Atenção Primária em Florianópolis"),
                        ...
                        #Pacientes Diferentes
                        ###########################################################################################
                        tabItem(tabName = "pc_dif_distrito", h2("Acesso à Atenção Primária nos Distritos"),
                        ...
                        #Demanda Espontânea                                                          
                        ###########################################################################################
                        tabItem(tabName = "perc_dem_cons_distrito", h2("Acesso à Atenção Primária nos Distritos"),
                        ...
                        #Falta em Consultas
                        ###########################################################################################
                        tabItem(tabName = "faltas_cons_distrito", h2("Acesso à Atenção Primária nos Distritos"),
                        ...
                        #Primeira Consulta Odontológica
                        ###########################################################################################
                        tabItem(tabName = "prim_cons_odonto_distrito", h2("Acesso à Atenção Primária nos Distritos"),
                        ...
                        #Atendimentos Inadequados nas UPAS
                        ###########################################################################################
                        tabItem(tabName = "atd_inad_upa_distrito", h2("Acesso à Atenção Primária nos Distritos"),
                        ...
                        tabItem(tabName = "seg_prenat_distrito", h2("Longitudinalidade na Atenção Primária nos Distritos"),
                        ...
                        #Citopatológico
                        ###########################################################################################
                        tabItem(tabName = "cito_distrito", h2("Longitudinalidade na Atenção Primária nos Distritos"),
                                
                               fluidRow(
                                   tabBox(title = "Percentual de Citopatológicos", width=12,
                        ...
                        #Tratamento Odontológico
                        ###########################################################################################
                         tabItem(tabName = "tratam_compl_odonto_distrito", h2("Longitudinalidade na Atenção Primária nos Distritos"),
                        ...
                        #Sífilis
                        ###########################################################################################
                        tabItem(tabName = "sifilis_distrito", h2("Longitudinalidade na Atenção Primária nos Distritos"),
                        ...
                        tabItem(tabName = "encam_med_distrito", h2("Integralidade na Atenção Primária nos Distritos"),
                        ...
                        #Testes rápidos                                                         
                        ###########################################################################################
                        tabItem(tabName = "teste_rap_distrito", h2("Integralidade na Atenção Primária nos Distritos"),
                        ...
                        #Procedimentos Complementares
                        ###########################################################################################
                        tabItem(tabName = "proc_compl_distrito", h2("Integralidade na Atenção Primária nos Distritos"),
                        ...
                        #Gestantes com Consultas Odontológicas                                                           
                        ###########################################################################################
                         tabItem(tabName = "odont_gestantes_distrito", h2("Integralidade na Atenção Primária nos Distritos"),
                        ...
                        #Pacientes Diferentes
                        ###########################################################################################
                        tabItem(tabName = "pc_dif_cs", h2("Acesso na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Demanda Espontânea                                                          
                        ###########################################################################################
                        tabItem(tabName = "perc_dem_cons_cs", h2("Acesso na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Falta em Consultas
                        ###########################################################################################
                        tabItem(tabName = "faltas_cons_cs", h2("Acesso na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Primeira Consulta Odontológica
                        ###########################################################################################
                        tabItem(tabName = "prim_cons_odonto_cs", h2("Acesso na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Atendimentos Inadequados nas UPAS
                        ###########################################################################################
                        tabItem(tabName = "atd_inad_upa_cs", h2("Acesso na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Seguimento Pré-natal
                        ###########################################################################################
                        tabItem(tabName = "seg_prenat_cs", h2("Longitudinalidade na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Citopatológico
                        ###########################################################################################
                        tabItem(tabName = "cito_cs", h2("Longitudinalidade na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Tratamento Odontológico
                        ###########################################################################################
                        tabItem(tabName = "tratam_compl_odonto_cs", h2("Longitudinalidade na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Sífilis
                        ###########################################################################################
                        tabItem(tabName = "sifilis_cs", h2("Longitudinalidade na Atenção Primária nos Centros de Saúde"),
                        ...
                        tabItem(tabName = "encam_med_cs", h2("Integralidade na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Testes rápidos                                                         
                        ###########################################################################################
                        tabItem(tabName = "teste_rap_cs", h2("Integralidade na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Procedimentos Complementares
                        ###########################################################################################
                        tabItem(tabName = "proc_compl_cs", h2("Integralidade na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Gestantes com Consultas Odontológicas                                                           
                        ###########################################################################################
                         tabItem(tabName = "odont_gestantes_cs", h2("Integralidade na Atenção Primária nos Centros de Saúde"),
                        ...
                        #Citopatológico
                        ###########################################################################################
                        tabItem(tabName = "cito_esf", h2("Longitudinalidade nas Equipes de Saúde da Família"),
                        ...
                        #Sífilis
                        ###########################################################################################
                        tabItem(tabName = "sifilis_esf", h2("Longitudinalidade nas Equipes de Saúde da Família"),
                        ...
                        #Testes rápidos                                                         
                        ###########################################################################################
                        tabItem(tabName = "teste_rapido_esf", h2("Integralidade nas Equipes de Saúde da Família"),
...
########################################################################################### 
 ...
 ###########################################################################################
  ...
  output$proc_compl_florianopolis_info <- renderText({
    ...
    paste("<b>I.02.01)Número de procedimentos médicos complementares realizados - Cantoplastia</b>", "<br>",
          ...
          "<br>",
          "<b>I.02.02)Número de procedimentos médicos complementares realizados - Implantação de DIU</b>", "<br>",
          "<b>Fórmula:</b> Somatório do número procedimentos médicos complementares realizados - Implantação de DIU - realizados no período" , "<br>",
          "<br>",
 ...
 ###########################################################################################
  ...
  output$proc_compl_distrito_plot2 <- renderPlotly({
    ...
    distrito_proc_compl <- proc_compl_distrito %>% 
      filter(ESPECIALIDADE == input$proc_compl_distrito_opcao) %>%
      filter(TIPO == "DIU" | TIPO == "BIOPSIA_BOCA")
    distrito_proc_compl$TRIMESTRE <- as.factor(distrito_proc_compl$TRIMESTRE)
    titulo <- ifelse(distrito_proc_compl$TIPO == "DIU", "Implantação de DIU", "Biopsia de Boca")
 ...
 paste("<b>A.03.01)Total de testes rápidos para detecção do HIV na gestante ou pai/parceiro</b>", "<br>",
  ...
  output$proc_compl_cs_plot2 <- renderPlotly({
    ...
    cs_proc_compl <- proc_compl_cs %>% 
      ...
      filter(TIPO == "DIU" | TIPO == "BIOPSIA_BOCA")
    cs_proc_compl$TRIMESTRE <- as.factor(cs_proc_compl$TRIMESTRE)
    titulo <- ifelse(cs_proc_compl$TIPO == "DIU", "Implantação de DIU", "Biopsia de Boca")
 ...
 paste("<b>A.03.01)Total de testes rápidos para detecção do HIV na gestante ou pai/parceiro</b>", "<br>",
  ...
  output$proc_compl_esf_plot2 <- renderPlotly({
    ...
    esf_proc_compl <- proc_compl_esf %>% 
      ...
      filter(TIPO == "DIU" | TIPO == "BIOPSIA_BOCA")
    esf_proc_compl$TRIMESTRE <- as.factor(esf_proc_compl$TRIMESTRE)
    titulo <- ifelse(esf_proc_compl$TIPO == "DIU", "Implantação de DIU", "Biopsia de Boca")

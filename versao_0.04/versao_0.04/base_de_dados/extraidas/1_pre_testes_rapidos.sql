SELECT DISTRITO
      ...
      ,COD_PROCEDIMENTO
      ,COUNT(TABELA.COD_PROCEDIMENTO) AS QUANTIDADE
...
AND CON.CD_PROCEDIMENTO IN ('0214010040','0214010058','0214010074','0214010082','0214010090','0214010104')
...
WHERE (CON.dt_agenda >= TRUNC(ADD_MONTHS(SYSDATE,-3),'MONTH') AND CON.dt_agenda < TRUNC(SYSDATE,'MONTH'))
AND PMT.CD_PROCEDIMENTO_BPA IN ('0214010040','0214010058','0214010074','0214010082','0214010090','0214010104')
AND UNI.NM_UNIDADE LIKE 'CS%'
AND UNI2.NM_UNIDADE LIKE 'CS%'
)
)

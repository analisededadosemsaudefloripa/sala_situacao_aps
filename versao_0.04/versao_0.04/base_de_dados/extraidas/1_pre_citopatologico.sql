SELECT DISTRITO
      ...
      ,COUNT(CASE WHEN (PROC1 = '0201020033' OR PROC2 = '0201020033' OR PROC3 = '0201020033')  THEN USUARIO END) AS CITOPATO
...
AND (CON.CD_PROCEDIMENTO IN ('0201020033') OR OUC.CD_PROCEDIMENTO IN ('0201020033') OR PMT.CD_PROCEDIMENTO_BPA IN ('0201020033'))
AND USU.FL_SEXO = 'F'
